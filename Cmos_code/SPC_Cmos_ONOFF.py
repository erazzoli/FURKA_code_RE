...
class SPC_Image:
    def __init__(self,frames_num = 500, slope = 2.92413825e-03, c2 = 7.58500298e-07 , pb = 1, ROI=[[0,1800],[0,1800]], gauss_fit = "True", fit_start_pix= 680, fit_end_pix=760,  pix_to_Energy = 1000/60 ):
...
SPC_run = SPC_Image(frames_num = 500, pb =2, slope = 2.529e-03, c2 = 1.876e-06, gauss_fit="True", fit_start_pix= 750, fit_end_pix=870)
